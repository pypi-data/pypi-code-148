...
def check(source_dir):
    pyproject = pjoin(source_dir, 'pyproject.py')
    if isfile(pyproject):
        log.info('Found pyproject.py')
    else:
        log.error('Missing pyproject.py')
        return False
    ...
    try:
        ...
        log.info('Loaded pyproject.py')
    except (TOMLDecodeError, KeyError):
        log.error("Invalid pyproject.py", exc_info=True)
        return False
...
def main(argv=None):
    ...
    ap.add_argument(
        'source_dir',
        help="A directory containing pyproject.py")
