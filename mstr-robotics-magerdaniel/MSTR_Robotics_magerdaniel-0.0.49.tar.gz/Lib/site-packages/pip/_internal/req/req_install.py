...
class InstallRequirement:
    ...
    def __init__(
        ...
        # is not necessarily the directory where pyproject.py or setup.py is
        ...
        # The static build requirements (from pyproject.py)
        ...
        # After pyproject.py has been loaded, the only valid values are True
        # and False. Before loading, None is valid (meaning "use the default").
        # Setting an explicit value before loading pyproject.py is supported,
    ...
    def isolated_editable_sanity_check(self) -> None:
        ...
        This verifies that an editable that has a pyproject.py either supports PEP 660
        ...
        if (
            ...
            raise InstallationError(
                f"Project {self} has a 'pyproject.py' and its build "
